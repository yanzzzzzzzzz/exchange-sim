...
class AccountControllerTest {
    ...
    @Nested
    @DisplayName("更新暱稱 Update Nickname Tests")
    class UpdateNicknameTests {
        ...
        @Test
        @DisplayName("成功更新自己的暱稱 (/me/nickname)")
        void shouldUpdateOwnNickname() throws Exception {
            ...
            webTestClient.patch()
                ...
                .jsonPath("$.user.id").exists()
                .jsonPath("$.user.nickname").isEqualTo("New Nickname")
                .jsonPath("$.user.updatedAt").exists();
        }

        @Test
        @DisplayName("成功更新指定使用者暱稱")
        void shouldUpdateUserNicknameById() throws Exception {
            Map<String, String> updateRequest = Map.of(
                "nickname", "Updated Nickname"
            );

            webTestClient.patch()
                .uri("/api/account/users/" + userId + "/nickname")
                .header("Authorization", "Bearer " + accessToken)
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(updateRequest)
                .exchange()
                ...
                .expectBody()
                .jsonPath("$.msg").isEqualTo("nickname updated")
                .jsonPath("$.user.nickname").isEqualTo("Updated Nickname");
        }

        @Test
        @DisplayName("暱稱長度超過限制應回傳 400")
        void shouldReturn400ForTooLongNickname() throws Exception {
            Map<String, String> updateRequest = Map.of(
                "nickname", "a".repeat(33) // 超過 32 字元
            );
        ...
        @Test
        @DisplayName("空暱稱應回傳 400")
        void shouldReturn400ForEmptyNickname() throws Exception {
            Map<String, String> updateRequest = Map.of(
                "nickname", ""
            );
        ...
        @Test
        @DisplayName("無 token 更新暱稱應回傳 401")
        void shouldReturn401WithoutToken() throws Exception {
            Map<String, String> updateRequest = Map.of(
                "nickname", "New Nickname"
            );
        ...
        @Test
        @DisplayName("更新不存在使用者的暱稱應回傳 404")
        void shouldReturn404ForNonExistentUser() throws Exception {
            Map<String, String> updateRequest = Map.of(
                "nickname", "New Nickname"
            );
            ...
            webTestClient.patch()
                .uri("/api/account/users/usr_nonexistent/nickname")
                .header("Authorization", "Bearer " + accessToken)
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(updateRequest)
                .exchange()
